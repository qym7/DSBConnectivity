...
CUDA_VISIBLE_DEVICES=2 python main.py dataset=qm9_smiles num_steps=10 num_iter=10 n_ipf=2

CUDA_VISIBLE_DEVICES=2 python main.py dataset=qm9_smiles n_ipf=100
