...
# codes for mini
CUDA_VISIBLE_DEVICES=0 python main.py dataset=comm20 model=gnn num_steps=50 num_iter=50 n_ipf=2 lr=0.001 gamma_max=0.1 project_name=marginal_mini dataset.datadir=data/comm20_single_graph_small/
