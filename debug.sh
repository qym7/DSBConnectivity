...
# # codes for comm20
# CUDA_VISIBLE_DEVICES=0 python main.py dataset=comm20 model=gnn project_name=debug num_iter=100 dataset.datadir=data/comm20_old/

# # codes for single
CUDA_VISIBLE_DEVICES=2 python main.py dataset=sbm_transfer model=gnn num_steps=50 num_iter=100 n_ipf=20 project_name=debug ema_rate=0.99
